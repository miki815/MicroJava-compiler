...
public class FuncCallOption extends DesignatorStatement {

    private Designator Designator;
    private FuncCallStart FuncCallStart;
    private ActPars ActPars;

    public FuncCallOption (Designator Designator, FuncCallStart FuncCallStart, ActPars ActPars) {
